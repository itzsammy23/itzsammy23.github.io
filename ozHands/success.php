...
<div id="loaded-content" style="margin: 200px auto; padding-top: 20px;  text-align: center;">
    ...
    <div class="further-content" id="further-views">
        <i class="fas fa-user-check" style="font-size: 65px; color: #003366;"></i>
        <p style="font-size: 18px">Your account has been successfully created.</p>
        <div align="center"><a href="cart.php" style="font-size: 18px; padding: 12px; background-color: #000;
         color: #fff; border-radius: 10px; text-decoration: none;">View Cart</a></div>
    </div>
</div>
