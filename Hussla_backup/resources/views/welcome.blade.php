    ...
    <body>
     ...
     <nav class="navbar navbar-expand-md landing-navbar">
            ...
            <div class="col-md-8 first-view pt-5 pl-5" id="first-view">
                <h2>In-demand Experts at your service</h2>
                <h4>Hussla.ng explicitly connects professionals and experts
                to clients with just a few clicks.<h4>
              

                <div class="links d-inline">
                    <a href="/servicefinder" class="btn mr-3 ml-3"><span>Get Started </span></a>
                    <a href="/register" class="btn-alternate mt-5">Sign Up</a>
                </div>
