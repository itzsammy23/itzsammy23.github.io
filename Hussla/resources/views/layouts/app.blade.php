...
<head>
    ...
    <link href="{{ asset('css/signupstyle.css') }}" rel="stylesheet">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->firstname ?? session('user_agent') }} <span class="caret"></span>
                                </a>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/customer/login">Sign Up(Customer)</a>
                                    </li>
