        ...
        <div class="form-file col-md-10" >
                    <form method="POST" action="{{ route('register') }}" onsubmit="return validateSlideFour();" name="register" id="register">
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="firstname" class="col-md-4">{{ __('First Name') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="lastname" class="col-md-4">{{ __('Last Name') }}</label>
                            <div class="col-md-10">
                   ...
                   <div class="tab">
                    <div class="form-group row d-block offset-2 pr-5" >
                            <label for="businessname" class="col-md-4">{{ __('Business Name') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="businessinfo" class="col-md-4">{{ __('Business Info') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="businessphone" class="col-md-4">{{ __('Business Phone') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="businessaddress" class="col-md-4">{{ __('Business Address') }}</label>
                            <div class="col-md-10">
                    ...
                    <div class="tab">
                    <div class="form-group row d-block offset-2 pr-5" >
                            <label for="specialize" class="col-md-4">{{ __('Specialization') }}</label>
				...
				<option value="Vehicle repair" id="selects">Vehicle repair</option>
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="businessmotto" class="col-md-4">{{ __('Business Motto') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="state" class="col-md-4">{{ __('State') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row d-block offset-2 pr-5" >
                            <label for="area" class="col-md-4">{{ __('Area') }}</label>
                            <div class="col-md-10">
